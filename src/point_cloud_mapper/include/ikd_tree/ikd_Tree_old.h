...
private:
  ...
  void Delete_by_range(KD_TREE_NODE** root,
                       BoxPointType boxpoint,
                       bool allow_rebuild,
                       bool is_downsample);
  void Delete_by_range_NEGATIVE(KD_TREE_NODE** root,
                                BoxPointType boxpoint,
                                bool allow_rebuild,
                                bool is_downsample);
  void
  ...
  void print_treenode(KD_TREE_NODE* root,
                      int index,
                      FILE* fp,
                      float x_min,
                      float x_max,
...
public:
  ...
  void Delete_Point_Boxes_NEGATIVE(vector<BoxPointType>& BoxPoints);
