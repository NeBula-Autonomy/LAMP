...
public:
  ...
  // Effective C++ item 37
  bool InsertPoints(const PointCloud::ConstPtr& points, PointCloud* incremental_points) override;
  ...
  // nearest neighbor.
  virtual bool ApproxNearestNeighbors(const PointCloud& points, PointCloud* neighbors) override;
